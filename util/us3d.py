...
if __name__ == '__main__':
    ...
    train_data = US3D(split='train', data_root="dataset/us3d/trainval", voxel_size=0.5, voxel_max=80000, transform=None, shuffle_index=False, loop=1)
    ...
    features = [] 
    labels = set()
    for i, (coord, feat, target, offset) in enumerate(tqdm(train_loader)):
